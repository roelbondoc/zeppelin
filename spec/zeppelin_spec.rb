...
describe Zeppelin do
  ...
  describe '#device_token' do
    ...
    it 'gets information about a device' do
      stub_requests do |stub|
        stub.get(uri) { [200, { 'Content-Type' => 'application/json' }, MultiJson.dump(response_body)] }
      end
  ...
  describe '#device_tokens' do
    ...
    it 'requests a page of device tokens' do
      stub_requests do |stub|
        stub.get('/api/device_tokens/?page=') { [200, { 'Content-Type' => 'application/json' }, MultiJson.dump(results_without_next_page)] }
      end
    ...
    it 'includes the page number of the next page' do
      stub_requests do |stub|
        stub.get('/api/device_tokens/?page=') { [200, { 'Content-Type' => 'application/json' }, MultiJson.dump(results_with_next_page)] }
      end
    ...
    it 'requests a specified page of device_tokens' do
      stub_requests do |stub|
        stub.get('/api/device_tokens/?page=4') { [200, { 'Content-Type' => 'application/json' }, MultiJson.dump(results_without_next_page)] }
      end
  ...
  describe '#register_apid' do
    ...
    it 'accepts a payload' do
      stub_requests do |stub|
        stub.put(uri, MultiJson.dump(payload)) { [200, {}, ''] }
      end
  ...
  describe '#apids' do
    ...
    it 'requests a page of APIDs' do
      stub_requests do |stub|
        stub.get('/api/apids/?page=') { [200, { 'Content-Type' => 'application/json' }, MultiJson.dump(results_without_next_page)] }
      end
    ...
    it 'includes the page number of the next page' do
      stub_requests do |stub|
        stub.get('/api/apids/?page=') { [200, { 'Content-Type' => 'application/json' }, MultiJson.dump(results_with_next_page)] }
      end
    ...
    it 'requests a specified page of APIDs' do
      stub_requests do |stub|
        stub.get('/api/apids/?page=4') { [200, { 'Content-Type' => 'application/json' }, MultiJson.dump(results_without_next_page)] }
      end
  ...
  describe '#push' do
    ...
    it 'is true when the request is successful' do
      stub_requests do |stub|
        stub.post(uri, MultiJson.dump(payload)) { [200, {}, ''] }
      end
